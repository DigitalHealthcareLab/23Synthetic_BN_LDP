...
pd.pivot_table(mlcr_required, index=['PT_SBST_NO','TIME'], columns= 'MLPT_KIND_NM', values='MLPT_RSLT_CONT')
...
#%%
mlcr_required = mlcr_required.drop_duplicates(subset=['PT_SBST_NO','TIME'])
