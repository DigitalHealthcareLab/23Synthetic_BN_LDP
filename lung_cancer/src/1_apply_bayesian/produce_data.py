...
INPUT_PATH = PROJ_PATH.joinpath('/mnt/synthetic_data/lung/data/processed/1_apply_bayesian/apply_bayesian/out/')
OUTPUT_PATH = PROJ_PATH.joinpath('/mnt/synthetic_data/lung/data/processed/1_apply_bayesian/produce_data')
...
def main():
    ...
    parser.add_argument('--epsilon','-e', type=int, help='choose the epsilon')
