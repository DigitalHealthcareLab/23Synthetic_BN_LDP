...
def main():
    ...
    parser.add_argument('--sample', '-s', default = False, help='choose whether to sample')
    parser.add_argument('--sample_number', '-sn', help='sample number', type=int)
...
#    epsilons  = config['epsilon']
    ...
    if args.sample :
        ...
        sampled_patients = random.sample(patients, args.sample_number)
