...
#%%
    ...
    data = data.dropna(subset=['IMPT_KIND_NM','IMPT_RSLT_CONT'], how='any')
    data = data.drop_duplicates(subset=['PT_SBST_NO','IMPT_KIND_NM','IMPT_RSLT_CONT'])
