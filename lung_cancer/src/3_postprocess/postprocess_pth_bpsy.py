...
#%%
    ...
    data = data.rename(columns = {'BMTHD_DETL_CONT':'BPTH_BPSY_MTHD_DETL_CONT'})
    data = data.dropna(subset=['BPTH_SITE_CONT','BPTH_BPSY_MTHD_DETL_CONT'], how='any')
    data = data.drop_duplicates(subset=['PT_SBST_NO','BPTH_SITE_CONT','BPTH_BPSY_MTHD_DETL_CONT'])
