...
INPUT_PATH = PROJ_PATH.joinpath('/mnt/synthetic_data/lung/data/processed/2_restore/restore_to_s1')
OUTPUT_PATH = PROJ_PATH.joinpath('/mnt/synthetic_data/lung/data/processed/2_restore/restore_to_db_form')
