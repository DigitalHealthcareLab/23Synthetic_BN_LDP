...
INPUT_PATH = Path('/mnt/synthetic_data/lung/data/processed/1_apply_bayesian/produce_data')
OUTPUT_PATH = Path('/mnt/synthetic_data/lung/data/processed/2_restore/restore_to_s1')
...
def main():
    ...
    pkl_path = Path('/mnt/synthetic_data/lung/data/processed/1_apply_bayesian/produce_data')
