...
INPUT_PATH = PROJ_PATH.joinpath('/mnt/synthetic_data/data/processed/1_apply_bayesian/preprocess_data/D0')
OUTPUT_PATH = PROJ_PATH.joinpath('/mnt/synthetic_data/data/processed/1_apply_bayesian/apply_bayesian/D0')
...
def main():
    ...
    data = read_file(Path('/mnt/synthetic_data/'), 'data/processed/0_preprocess/D0.pkl')
