...
INPUT_PATH = Path('/mnt/synthetic_data/data/processed/1_apply_bayesian/apply_bayesian/D0/out')
OUTPUT_PATH = Path('/mnt/synthetic_data/data/processed/1_apply_bayesian/produce_data/D0')
...
def generate_data(epsilon, description_idx, sample_number):
    ...
    original_data_path = Path(f'/mnt/synthetic_data/data/processed/1_apply_bayesian/preprocess_data/D0/pt_{description_idx}.csv')
