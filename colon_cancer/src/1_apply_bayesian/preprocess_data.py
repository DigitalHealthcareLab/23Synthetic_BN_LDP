...
INPUT_PATH = Path('/mnt/synthetic_data/data/processed/0_preprocess')
OUTPUT_PATH = Path('/mnt/synthetic_data/data/processed/1_apply_bayesian/preprocess_data/D0_train')
...
#%%
def load_input_data():
    path = INPUT_PATH.joinpath('D0_train.pkl')
