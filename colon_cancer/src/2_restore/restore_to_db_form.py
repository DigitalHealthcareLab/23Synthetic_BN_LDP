...
INPUT_PATH = Path('/mnt/synthetic_data/data/processed/2_restore/restore_to_s1/D0_train')
OUTPUT_PATH = Path('/mnt/synthetic_data/data/processed/2_restore/restore_to_db_form/D0_train')
