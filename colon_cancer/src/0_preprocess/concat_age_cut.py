...
selected = all_concated[['PT_SBST_NO',
 'TIME',
 'DG_RCNF_RLPS',
 'EX_DIAG_CEA',
 'OPRT_NFRM_OPRT_CLCN_OPRT_KIND_CD',
 'PTH_BPSY_BPTH_BPSY_RSLT_CONT',
 'PTH_BPSY_BPTH_CELL_DIFF_CD',
 'PTH_MLCR_MLPT_BRME_RSLT_CD',
 'PTH_MLCR_MLPT_KRES_RSLT_CD',
 'PTH_MLCR_MLPT_MSIE_RSLT_CD',
 'PTH_MLCR_MLPT_NREX_RSLT_CD',
 'PTH_MNTY_IMPT_HM1E_RSLT_CD',
 'PTH_MNTY_IMPT_HP2E_RSLT_CD',
 'PTH_SRGC_SGPT_CELL_DIFF_CD',
 'PTH_SRGC_SGPT_MTST_LN_CNT',
 'PTH_SRGC_SGPT_NERV_PREX_CD',
 'PTH_SRGC_SGPT_PATL_M_STAG_VL',
 'PTH_SRGC_SGPT_PATL_N_STAG_VL',
 'PTH_SRGC_SGPT_PATL_T_STAG_VL',
 'PTH_SRGC_SGPT_SRMG_PCTS_STAT_CD',
 'PTH_SRGC_SGPT_SRMV_LN_CNT',
 'PTH_SRGC_SGPT_TUMR_BUDD_CD',
 'PTH_SRGC_SGPT_VNIN_CD',
 'PTH_SRGC_SGPT_ANIN_CD',
 'PT_BSNF_BSPT_FRST_DIAG_CD',
 'PT_BSNF_BSPT_IDGN_AGE',
 'PT_BSNF_BSPT_M_STAG_VL',
 'PT_BSNF_BSPT_N_STAG_VL',
 'PT_BSNF_BSPT_SEX_CD',
 'PT_BSNF_BSPT_STAG_VL',
 'PT_BSNF_BSPT_T_STAG_VL',
 'PT_BSNF_BSPT_FRST_DIAG_YMD',
 'TRTM_CASB_CSTR_NT',
 'TRTM_CASB_CSTR_PRPS_CD',
 'TRTM_CASB_CSTR_REGN_CD',
 'DEAD_NFRM_DEAD']]

#%%
if output_path.joinpath('0_preprocess').exists() :
    #all_concated.to_pickle(output_path.joinpath('0_preprocess/D1').joinpath('D1.pkl'))
    select_dtypes.to_pickle(output_path.joinpath('0_preprocess/D1').joinpath('D0_selected.pkl'))
else :
